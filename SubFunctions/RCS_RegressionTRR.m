function [normalizedImg_train, R_squared_train, slope_train, intercept_train, fitParameters] = RCS_RegressionTRR(ptsScene1_test, ptsObj1_test, imgObj_test,imgScene_test,Num)
