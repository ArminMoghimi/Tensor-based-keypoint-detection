function [normalizedImg_train, R_squared_train, slope_train, intercept_train, fitParameters,Initial_Image] = RCS_RegressionGA37(ptsScene1_test, ptsObj1_test, imgObj_test, Num, regressionType)
    ...
    for i = 1:m3
        ...
        if ~all(R_DN(:, i) == 0) && ~all(S_DN(:, i) == 0)
            ...
            [fitParameters{i}, ~, ~, ~, ~] = ga(objectiveFcn, length(initialGuess), [], [], [], [], lb, ub, [], gaOptions);
