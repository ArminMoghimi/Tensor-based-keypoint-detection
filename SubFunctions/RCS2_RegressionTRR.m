function [normalizedImg_train, R_squared_train, slope_train, intercept_train, fitParameters, Initial_Image] = RCS2_RegressionTRR(ptsScene1_test, ptsObj1_test, imgObj_test, imgScene_test, Num, regressionType)
